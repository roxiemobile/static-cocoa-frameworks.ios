...
# MARK: - iOS Static Framework
  ...
  s.source = {
    http: "https://dl.bintray.com/roxiemobile/generic/RxSwift-#{s.version}-SCF50.zip",
    sha256: '6f917ee4cdd23952a3f42d1ff44bf79a1f8d71ce2c1822a446d05da67786d666'
  }
  ...
  s.subspec 'StaticCocoaFramework' do |sc|
    ...
    # Dependencies
    #sc.dependency 'RxAtomic-SCF42', '~> 4.4.0'
  end
