...
# MARK: - iOS Static Framework
  ...
  s.source = {
    http: "https://dl.bintray.com/roxiemobile/generic/SQLite.swift+SQLCipher-#{s.version}-SCF53.zip",
    sha256: 'd5efe3eabe755bde6b1aadd25383e2e17d7f65a88bc8a88c89cc8605086069d9'
  }
  ...
  s.subspec 'StaticCocoaFramework' do |sc|
    ...
    # Dependencies
    sc.dependency 'SQLCipher-SCF53', '>= 3.4.2'
  end
end
