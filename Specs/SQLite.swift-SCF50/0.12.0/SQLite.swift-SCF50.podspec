...
=end
    ss.dependency "#{s.name}-SCF50/StaticCocoaFramework", s.version.to_s
  end
...
# MARK: - iOS Static Framework
  ...
  s.source = {
    http: "https://dl.bintray.com/roxiemobile/generic/SQLite.swift+SQLCipher-#{s.version}-SCF50.zip",
    sha256: '1094bedd60445d007b84028c9622e7ba52feddcdb349a7d0671d0415ea9effd5'
  }
  ...
  s.subspec 'StaticCocoaFramework' do |sc|
    ...
    # Dependencies
    sc.dependency 'SQLCipher-SCF50', '~> 4.0.1'
  end
end