...
# MARK: - iOS Static Framework
  ...
  s.source = {
    http: 'https://dl.bintray.com/roxiemobile/generic/ContentProvidersSQLite-1.1.0-SCF.zip',
    sha256: 'f1b9b45c935b8df15700cbf21b42e5356c1ecda81e2553f827da110722373b6f'
  }
  ...
  s.subspec 'StaticCocoaFramework' do |sc|
    ...
    sc.dependency 'SwiftCommons-SCF/Concurrent', '~> 1.1.0'
    sc.dependency 'SwiftCommons-SCF/Extensions', '~> 1.1.0'
