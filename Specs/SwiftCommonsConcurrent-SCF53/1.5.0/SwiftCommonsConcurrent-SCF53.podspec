...
# MARK: - iOS Static Framework
  ...
  s.source = {
    http: "https://dl.bintray.com/roxiemobile/generic/SwiftCommonsConcurrent-#{s.version}-SCF53.zip",
    sha256: 'e4f4c8d799c05d1e65f36d2593ba982d414aae4fd7b31e52f70215eee8c99fe6'
  }
  ...
  s.subspec 'StaticCocoaFramework' do |sc|
    ...
    # Dependencies
    sc.dependency 'Dispatch-SCF53', '~> 2.0.4'
    sc.dependency 'SwiftCommonsObjC-SCF53', s.version.to_s
  end
