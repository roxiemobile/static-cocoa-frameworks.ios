...
# MARK: - iOS Static Framework
  ...
  s.source = {
    http: 'https://dl.bintray.com/roxiemobile/generic/ModernDesignExtensions-1.2.0-SCF.zip',
    sha256: '76576072333ba22b4ca2c7c436570d345ccedea7643c7db5061571f958f3bc88'
  }
  ...
  s.subspec 'StaticCocoaFramework' do |sc|
    ...
    # Dependencies
    sc.dependency 'SwiftCommons-SCF/Lang', '~> 1.2.5'
  end
end
