...
=end
    sp.dependency 'SwiftCommonsAbstractions-SCF53', s.version.to_s
  end
...
=end
    sp.dependency 'SwiftCommonsConcurrent-SCF53', s.version.to_s
  end
...
=end
    sp.dependency 'SwiftCommonsData-SCF53', s.version.to_s
  end
...
=end
    sp.dependency 'SwiftCommonsDiagnostics-SCF53', s.version.to_s
  end
...
=end
    sp.dependency 'SwiftCommonsExtensions-SCF53', s.version.to_s
  end
...
=end
    sp.dependency 'SwiftCommonsLang-SCF53', s.version.to_s
  end
...
=end
    sp.dependency 'SwiftCommonsLogging-SCF53', s.version.to_s
  end
...
=end
    sp.dependency 'SwiftCommonsObjC-SCF53', s.version.to_s
  end
...
# MARK: - iOS Static Framework
  ...
  s.source = {
    http: "https://dl.bintray.com/roxiemobile/generic/SwiftCommons-#{s.version}-SCF53.zip",
    sha256: '2656d02be703dda063f6331789bf484d8f5187a3a4e6a05f8937e39df9d239ce'
  }
