...
# MARK: - iOS Static Framework
  ...
  s.source = {
    http: "https://dl.bintray.com/roxiemobile/generic/SwiftCommonsData-#{s.version}-SCF53.zip",
    sha256: '9c5bc74f9effd0310c290215a928a584998e1645e340a0152193003e4225a315'
  }
  ...
  s.subspec 'StaticCocoaFramework' do |sc|
    ...
    sc.dependency 'MPMessagePack-SCF53', '~> 1.5.1'
    sc.dependency 'SwiftCommonsDiagnostics-SCF53', s.version.to_s
  end
