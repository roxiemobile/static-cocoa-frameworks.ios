...
=end
    core.dependency "#{s.name}-SCF50/StaticCocoaFramework"
  end
...
# MARK: - iOS Static Framework
  ...
  s.source = {
    http: "https://dl.bintray.com/roxiemobile/generic/SDWebImage+Core-#{s.version}-SCF50.zip",
    sha256: '1625c5568f0b290cbddac79cb19350f78d7564b3f6342af149cb30bc0cd6ea9f'
  }
