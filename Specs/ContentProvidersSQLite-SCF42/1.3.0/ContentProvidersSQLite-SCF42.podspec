...
# MARK: - iOS Static Framework
  ...
  s.source = {
    ...
    sha256: '8aec6190581cf8bdc608001afb1960c9577069b49edbebcd859aade587e725ae'
  }
  ...
  s.subspec 'StaticCocoaFramework' do |sc|
    ...
    sc.dependency 'SwiftCommons-SCF42/Concurrent', '~> 1.3.0'
    sc.dependency 'SwiftCommons-SCF42/Extensions', '~> 1.3.0'
